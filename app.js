...
;
const BUILD_TIMESTAMP = "2026 May 26 04:11:46";
const BUILD_TIMESTAMP_SHORT = "May 26 04:11";
                ...
                <div class="pip-layout" style="position: relative; height: 100vh; overflow: hidden; display: flex; flex-direction: column;">
                    <header class="pip-header">
                        ...
                        <div class="pip-header-right" style="display: flex; flex-direction: column; align-items: flex-end; gap: 3px; justify-content: center;">
                            ...
                            <span class="pip-updated-time" style="font-size: 8px; color: rgba(255,255,255,0.35); font-family: 'Outfit', sans-serif; font-weight: 500; text-transform: uppercase; white-space: nowrap; letter-spacing: 0.5px; margin-top: 1px;">UPDATED: May 26 04:11</span>
                        </div>
                    </header>
