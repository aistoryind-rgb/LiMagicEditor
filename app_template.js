                    ...
                    <header class="pip-header">
                        ...
                        <div class="pip-header-right" style="display: flex; align-items: center; gap: 8px;">
                            <div style="display: flex; flex-direction: column; align-items: flex-end; line-height: 1.2;">
                                ...
                                <span class="pip-last-updated" style="font-size: 8px; color: rgba(255,255,255,0.25); font-family: 'Outfit', sans-serif; font-weight: 500; text-transform: uppercase; letter-spacing: 0.5px; white-space: nowrap;">Updated: __BUILD_TIMESTAMP_SHORT__</span>
                            </div>
