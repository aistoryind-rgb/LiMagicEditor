                    ...
                    <header class="pip-header">
                        ...
                        <div class="pip-header-right" style="display: flex; align-items: center; gap: 8px;">
                            <div style="display: flex; flex-direction: column; align-items: flex-end; line-height: 1.25;">
                                ...
                                <span class="pip-updated-time" style="font-size: 8px; color: rgba(255,255,255,0.35); font-family: 'Outfit', sans-serif; font-weight: 500; margin-top: 2.5px; text-transform: uppercase; white-space: nowrap; letter-spacing: 0.5px;">Updated: __BUILD_TIMESTAMP_SHORT__</span>
                            </div>
                        </div>
                    </header>
