...
$compiled = $template.Replace("__VEHICLES_JSON__", $vehicles).Replace("__CLOTHING_JSON__", $clothing).Replace("__BUILD_TIMESTAMP__", $timestamp).Replace("__BUILD_TIMESTAMP_SHORT__", $timestampShort)
