export interface ClothingGenderItems {
  MASKS?: string[];
  BACKPACKS?: string[];
  ACCESSORY?: string[];
  WATCH?: string[];
  ...
  SHOES?: string[];
  HEADWEAR?: string[];
  "ANIMATED ITEMS"?: string[];
  "SPATIAL SOUND EFFECTS"?: string[];
  "BACKPACK SKINS"?: string[];
}

export interface ClothingDatabase {
  female: ClothingGenderItems;
  male: ClothingGenderItems;
}

export const CLOTHING_DB: ClothingDatabase = {
  female: {
    MASKS: [],
    BACKPACKS: [],
    ACCESSORY: [
